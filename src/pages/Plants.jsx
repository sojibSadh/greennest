        ...
        {plants.map((plant) => (
          ...
          >
            ...
            <div className="p-4 space-y-5">
              <h3 className="text-xl text-center font-semibold text-green-700">
                {plant.plantName}
              </h3>
              <div className="flex justify-between">
                <p className="text-gray-500 font-medium">Plant Price  <span className="text-orange-400"> ${plant.price} </span></p>
              ...
              <Link
                to={`/plants/${plant.plantId}`}
                className="block mt-2 bg-green-500 text-white text-center py-2 rounded-lg hover:bg-green-600 transition"
              >
                View Details
              </Link>
            </div>
